...
// Perfect square numbers from 1 to n are 1, 4, 9, 16, 25 .... Let's say those of perfect numbers S. S[1] = 1, S[2] = 4... S[n]-S[n-1is odd number from 1 (i.e. 1, 3, 5, 7...) Therefore, subtract 1, 3, 5, 7... from the given number num. If the result is 0, then it is perfect number.
